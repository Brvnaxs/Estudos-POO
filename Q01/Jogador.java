...
public class Jogador {
    ...
    public int aposentadoria(int idade){
        int tempo = 0;
        if(this.posicao.equals("Defesa") || this.posicao.equals("defesa")){
            tempo = 40 - idade;
        } else if (this.posicao.equals("Meio-campo") || this.posicao.equals("meio-campo")) {
            tempo = 38 - idade;
        } else if (this.posicao.equals("Atacante") || this.posicao.equals("atacante")) {
            tempo = 35 - idade;
        }
        return tempo;
    }
